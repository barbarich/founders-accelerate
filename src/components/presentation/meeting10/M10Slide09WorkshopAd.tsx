...
const blocks = [
  ...
  {
    t: "CTA",
    body: "Sign Up / Shop Now / Learn More / Send Message. Одно действие, без «или». Send Message — для Dira (click-to-WhatsApp).",
  },
  {
...
export default function M10Slide09WorkshopAd() {

...
const steps = [
  ...
  },
  {
    ...
    body: "Включаем, если product = жильё, кредит, работа, политика. Note для Dira.click: housing — обязательно. Иначе Meta заблокирует кампанию.",
  },
];

export default function M10Slide07WorkshopCampaign() {

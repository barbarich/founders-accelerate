...
import M6Slide01Welcome from "./M6Slide01Welcome";
import M6Slide03Theme from "./M6Slide03Theme";
import M6Slide07Aha from "./M6Slide07Aha";
import M6Slide08Onboarding from "./M6Slide08Onboarding";
import M6SlidePrompt from "./M6SlidePrompt";
import M6SlideParticipants from "./M6SlideParticipants";
import M6SlideCommitment from "./M6Slide14Commitment";
import M6SlideHomework from "./M6Slide15Homework";
...
export function getSlideContent(index: number) {
  switch (index) {
    ...
    case 2: return <M6Slide07Aha />;
    case 3: return <M6Slide08Onboarding />;
    case 4: return <M6SlidePrompt />;
    case 5: return <M6SlideParticipants />;
    case 6: return <M6SlideCommitment />;
    case 7: return <M6SlideHomework />;
    case 8: return <M6SlideNextWeek />;
    case 9: return <M6SlideClosing />;
    default: return null;
  }
}
    ...
    return (
      <div className="w-full h-screen bg-[hsl(var(--background))] overflow-auto p-8">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-semibold text-foreground">Встреча 6 — Все слайды</h2>

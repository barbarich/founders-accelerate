...
const bullets = [
  "15 лет в бизнесе, 6 из них в tech",
  "3 экзита (tech-продукты + ресторанный бизнес)",
  "Опыт CEO в международных компаниях",
  "Построил продукты от $0 до $3M ARR",
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-[100px]">
        ...
        <h2 className="text-[64px] font-bold text-[hsl(var(--slide-text))] leading-tight mb-[12px]">
          Кто я
        </h2>

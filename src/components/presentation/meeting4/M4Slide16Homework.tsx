...
const tasks = [
  {
    num: "1",
    title: "20 outreach-сообщений",
    desc: "Персонализированные сообщения потенциальным клиентам. Формула: наблюдение → инсайт → мост → мягкий CTA.",
    checklist: [
      "Apollo — найти контакты (email, должность, компания)",
      "Instantly — запустить email-цепочку из 3 писем",
      "LinkedHelper — автоматический outreach в LinkedIn",
    ],
  },
  {
    num: "2",
    title: "Первый пост о продукте",
    desc: "Опубликовать пост в LinkedIn, Facebook или Telegram. Расскажи историю: зачем делаешь, для кого, что уже работает.",
    checklist: [
      "Формат: личная история + конкретный результат",
      "CTA: попробуй бесплатно / дай фидбек",
...
export default function M4Slide16Homework() {

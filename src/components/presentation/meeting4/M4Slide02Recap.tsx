...
export default function M4Slide02Recap() {
  const items = [
    { num: "01", emoji: "🚀", title: "MVP scope определён", text: "Понятно что должно быть в продукте: MoSCoW, 3-4 ключевые фичи" },
    { num: "02", emoji: "🖥️", title: "Лендинг и упаковка", text: "Структура из 8 блоков, формула результата, аналитика" },
    { num: "03", emoji: "🤖", title: "AI-стек освоен", text: "Lovable, Claude Code, Cursor — умеете дорабатывать продукт без разработчика" },
    { num: "04", emoji: "📣", title: "План привлечения", text: "Знаете куда идти за первыми пользователями — посты, группы, outreach" },
  ];
  ...
  if (isMobile) {
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[28px]">
        <p className="text-[10px] uppercase tracking-[0.2em] text-[hsl(var(--slide-gold))] font-medium mb-[6px]">Прошлые 3 недели</p>
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      <p className="text-[18px] uppercase tracking-[0.2em] text-[hsl(var(--slide-gold))] font-medium mb-[16px]">Прошлые 3 недели</p>

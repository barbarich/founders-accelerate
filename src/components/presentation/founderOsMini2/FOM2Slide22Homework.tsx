...
const tasks = [
  ...
  ["Показать прототип или поделиться идеей с тремя людьми из ЦА", "Записать реакцию: что поняли, что нет, готовы ли заплатить названную цену. Видео или короткие выдержки."],

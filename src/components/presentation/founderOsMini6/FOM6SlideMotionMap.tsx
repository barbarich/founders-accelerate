...
// FOM6-копия M11Slide03MotionMap. Отличие — шаг 3 «Как заходим»:
// убрана философия «жди повода / не пиши в холодную» (найти триггер вживую сложно),
// заменена на «персонально, но в объёме» — пишем многим, но каждому с живой деталью.
const steps = [
  ...
  { n: "3", name: "Как заходим", goal: "персонально, но в объёме", out: "пишем по всему списку — но в каждое сообщение вшиваем 1 живую деталь про человека, не безликий шаблон" },
...
export default function FOM6SlideMotionMap() {

...
// FOM6-копия M11Slide10Discovery (структура демо). Отличие — шаг 4:
// убрано «ВАУ каждые 60–90 секунд» (30 «вау» за встречу невозможно).
// Заменено на «ВАУ периодически + запоминай, что зацепило, и повторяй
// на следующих встречах» (формулировка Михаэля 2026-06-17).
const steps = [
  {
    n: "1",
  ...
  {
    n: "4",
    q: "ВАУ-моменты — периодически по ходу, не сплошняком",
    listen: "30 «вау» за встречу невозможно. Достаточно, чтобы сильные моменты появлялись регулярно: один клик → одна понятная выгода в часах или деньгах. Запоминай, какой именно «вау» зацепил этого клиента — и осознанно повторяй его на следующих встречах с ним и с похожими.",
  },
  {
    n: "5",
...
export default function FOM6SlideDemoFlow() {

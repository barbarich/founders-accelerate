...
export default function FOM6Slide01Cover() {
      ...
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-[28px] h-full">
          ...
          <p className="uppercase tracking-[0.2em] text-[hsl(var(--slide-gold))] text-[10px] font-medium mb-[10px]">
            The Founders Circle · Сессия 6 из 6 · финал
          </p>
          <h1 className="font-display text-[26px] font-bold text-[hsl(var(--slide-text))] leading-[1.1] tracking-[-0.02em]">
            Продажи.<br />
            <span className="text-[hsl(var(--slide-gold))]">От заявки</span> до первых денег.
          </h1>
          <div className="mt-[18px] space-y-[8px] text-[12px] text-[hsl(var(--slide-text))] leading-[1.5]">
            <p><span className="text-[hsl(var(--slide-gold))]">→</span> 120 минут · 2 фаундера · финальная встреча программы</p>
            <p><span className="text-[hsl(var(--slide-gold))]">→</span> рамка дня: путь сделки → кого и через что → звонок → после «да»</p>
            <p><span className="text-[hsl(var(--slide-gold))]">→</span> уходим с планом на 90 дней и первой сделкой в работе</p>
          </div>
        </div>
        <FOM6Footer slide={1} />
      </div>
    ...
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center px-[140px] max-w-[1500px] h-full">
        ...
        <p className="uppercase tracking-[0.25em] text-[hsl(var(--slide-gold))] text-[20px] font-medium mb-[28px]">
          The Founders Circle · Сессия 6 из 6 · финал программы
        </p>
        ...
        <div className="mt-[44px] grid grid-cols-3 gap-[32px] max-w-[1500px]">
          <div className="border-l-2 border-[hsl(var(--slide-gold))] pl-[20px]">
            ...
            <p className="text-[22px] text-[hsl(var(--slide-text))] leading-[1.35]">120 минут · финальная встреча программы</p>
          </div>
          <div className="border-l-2 border-[hsl(var(--slide-gold))] pl-[20px]">
            <p className="text-[14px] uppercase tracking-[0.15em] text-[hsl(var(--slide-gold))] mb-[8px]">Рамка дня</p>
            <p className="text-[22px] text-[hsl(var(--slide-text))] leading-[1.35]">путь сделки → кого и через что → звонок → после «да»</p>
          </div>
          <div className="border-l-2 border-[hsl(var(--slide-gold))] pl-[20px]">
            <p className="text-[14px] uppercase tracking-[0.15em] text-[hsl(var(--slide-gold))] mb-[8px]">С чем уходим</p>
            <p className="text-[22px] text-[hsl(var(--slide-text))] leading-[1.35]">план на 90 дней + первая сделка в работе</p>
          </div>
        </div>
      </div>
      <FOM6Footer slide={1} />

...
const creation = [
  ...
  { name: "Kling / Veo 3", body: "видео из текста", price: "$8–25/мес" },
...
const launch = [
  ...
  { name: "Google PMax", body: "B2C · позже, не на старте", price: "от $20/день" },
...
export default function M9Slide20FullStack() {

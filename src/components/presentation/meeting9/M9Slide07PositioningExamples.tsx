...
const examples = [
  { brand: "MetaMinder", body: "Помогает performance-маркетологам в e-commerce агентствах ловить аномалии в Meta Ads за минуты через AI-мониторинг 24/7, в отличие от ручного daily-review, который пропускает сливы бюджета до конца дня." },
  { brand: "Mikey AI", body: "Помогает одиноким взрослым 28–40 лет понять причины своих неудач в свиданиях через AI-разбор переписок и поведения, в отличие от dating-app советов, которые рассказывают «как», но не «почему»." },
...
export default function M9Slide07PositioningExamples() {

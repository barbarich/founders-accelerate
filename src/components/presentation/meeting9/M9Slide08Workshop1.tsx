...
const steps = [
  { n: "1", t: "Заполни формулу для своего продукта", d: "[Продукт] помогает [узкий сегмент] достичь [результат] через [механизм], в отличие от [альт], которая [слабость]. Одна фраза, до 30 слов." },
  { n: "2", t: "Прогони через три теста", d: "Billboard · 5 секунд · Конкурент не может сказать то же. Если хоть один тест провалился — переписывай прямо сейчас." },
  { n: "3", t: "Запиши итог в чат", d: "Скидываем в общий чат финальную формулу. Группа читает, ищет слабые места — а не хвалит." },
];

export default function M9Slide08Workshop1() {

...
const topics = [
  "Монетизация: цена, которая не отпугивает",
  "Free vs trial vs freemium — что выбрать вашему продукту",
  "Первые 10 платящих: как найти и не сжечь",
  "AI-эксперименты с ценой за 1 день",
];

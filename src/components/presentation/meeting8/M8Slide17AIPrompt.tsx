...
const promptLines = [
  ...
  "",
  "# КОНТЕКСТ ПРОДУКТА (заполни)",
  "- Название: [продукт]",
  "- Категория: [B2B SaaS / AI-tool / consumer app / marketplace]",
  "- Что делает в одном предложении: [глагол + для кого + результат]",
  "- ICP (1 сегмент, не 'все'): [роль, контекст, размер компании]",
  "- JTBD: «Когда [ситуация], я хочу [мотивация], чтобы [результат]»: [JTBD]",
  "- Activation moment (момент 'aha'): [конкретное действие + метрика, напр. 'создал 1 отчёт и поделился ссылкой']",
  "- Time-to-value цель: [часы/дни от регистрации до aha]",
  "- Главный барьер №1, на котором отваливаются: [барьер]",
  "- Конкуренты, от которых уходят: [2-3 названия]",
  "- Tone of voice: [3 прилагательных, напр. 'прямой, тёплый, без жаргона']",
  "- Имя отправителя (реальный человек, не бренд): [Имя, роль]",
  "",
  "# ЗАДАЧА",

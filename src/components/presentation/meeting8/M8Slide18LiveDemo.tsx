...
const steps = [
  { t: "0:00", a: "Регистрируешься в SendPulse, подключаешь домен через DNS-запись (SPF + DKIM)" },
  { t: "0:45", a: "В Lovable: один fetch-запрос в SendPulse API после события signup — добавляешь юзера в адресную книгу" },
  { t: "1:30", a: "В SendPulse создаёшь автоматизацию: «событие not_returned_3d → шаблон письма»" },

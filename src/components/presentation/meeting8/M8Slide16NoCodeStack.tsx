...
const tools = [
  { cat: "Видеть, кто не вернулся", name: "PostHog", price: "Бесплатно до 1M событий", what: "Retention-кривая, когорты, funnels — за 10 минут. Всё, что раньше требовало аналитика." },
  { cat: "Триггерные письма", name: "Loops / Customer.io", price: "От $0 / $100", what: "Письмо отправляется по событию. «Не вернулся 3 дня» → письмо. Без кода." },
  { cat: "Push-уведомления", name: "OneSignal / Knock", price: "Бесплатно до 10k подписчиков", what: "Web + mobile push. Подключение к Lovable — 1 SDK, 5 строк." },
  { cat: "AI-чат, который возвращает", name: "Intercom Fin / Crisp AI", price: "От $39 / $0", what: "Бот отвечает на возражения, доводит до действия. Возврат через диалог, а не через рассылку." },

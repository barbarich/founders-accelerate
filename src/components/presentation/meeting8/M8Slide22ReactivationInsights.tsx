...
const insights = [
  ...
  },
  {
    ...
    d: "Вернувшийся за -50% уйдёт через неделю и будет ждать следующую акцию. Возвращай ценностью, а не ценой — иначе обучаешь юзера ждать.",
  },
  {
    n: "3",
  ...
  },
  {
    ...
    d: "Письмо «всем ушедшим» = спам. Бил один раз по «зарегался → не дошёл до aha» — конверсия в возврат 12–18%. По «активным → пропал» — другой текст, другой оффер.",
  },
  {
    n: "5",
...
export default function M8Slide22ReactivationInsights() {

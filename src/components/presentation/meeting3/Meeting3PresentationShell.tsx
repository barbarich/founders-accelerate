...
import M3Slide01Welcome from "./M3Slide01Welcome";
import M3Slide02Recap from "./M3Slide02Recap";
import M3Slide03ThreeThings from "./M3Slide03ThreeThings";
import M3BlockHeader from "./M3BlockHeader";
import M3Slide04ShowProgress from "./M3Slide04ShowProgress";
import M3Slide05MetaMinderCase from "./M3Slide05MetaMinderCase";
import M3Slide06AIStack from "./M3Slide06AIStack";
import M3Slide07AdvancedPrompts from "./M3Slide07AdvancedPrompts";
import M3Slide08BeforeAfter from "./M3Slide08BeforeAfter";
import M3Slide09LandingFromFrameworks from "./M3Slide09LandingFromFrameworks";
import M3Slide10LandingAnatomy from "./M3Slide10LandingAnatomy";
import M3Slide11LovableDemo from "./M3Slide11LovableDemo";
import M3Slide12AuthPayments from "./M3Slide12AuthPayments";
import M3Slide13Analytics from "./M3Slide13Analytics";
import M3Slide14Workshop from "./M3Slide14Workshop";
...
export const slideNames = [
  ...
  "Три вещи",
  "Блок 1: Разбор прогресса",
  "Покажите прогресс",
  "Блок 2: AI = продуктовая команда",
  "Кейс MetaMinder",
  "Ваш AI-стек",
  "Промпты, которые работают",
  "До / После",
  "Блок 3: Лендинг за 30 минут",
  "8 блоков лендинга",
  "Промпт для Lovable",
  "Стиль для Lovable",
  "Блок 4: Без разработчика",
  "Авторизация и оплата",
  "Аналитика",
  "Блок 5: Делаем вместе",
  "Два трека",
  "Блок 6: Задание",
  "Домашка",
  "Закрытие",
...
export function getSlideContent(index: number) {
  switch (index) {
    ...
    case 2: return <M3Slide03ThreeThings />;
    case 3: return <M3BlockHeader blockNumber={1} title="Разбор прогресса" subtitle="~25 минут" />;
    case 4: return <M3Slide04ShowProgress />;
    case 5: return <M3BlockHeader blockNumber={2} title="AI заменяет продакта и дизайнера" />;
    case 6: return <M3Slide05MetaMinderCase />;
    case 7: return <M3Slide06AIStack />;
    case 8: return <M3Slide07AdvancedPrompts />;
    case 9: return <M3Slide08BeforeAfter />;
    case 10: return <M3BlockHeader blockNumber={3} title="Лендинг за 30 минут" />;
    case 11: return <M3Slide09LandingFromFrameworks />;
    case 12: return <M3Slide10LandingAnatomy />;
    case 13: return <M3Slide11LovableDemo />;
    case 14: return <M3BlockHeader blockNumber={4} title="Подключаем без разработчика" />;
    case 15: return <M3Slide12AuthPayments />;
    case 16: return <M3Slide13Analytics />;
    case 17: return <M3BlockHeader blockNumber={5} title="Делаем вместе" subtitle="~20 минут" />;
    case 18: return <M3Slide14Workshop />;
    case 19: return <M3BlockHeader blockNumber={6} title="Задание на неделю" />;
    case 20: return <M3Slide15Homework />;
    case 21: return <M3Slide16Closing />;
    default: return null;
  }
}
    ...
    return (
      <div className="w-full h-screen bg-[hsl(var(--background))] overflow-auto p-8">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-semibold text-foreground">Встреча 3 — Все слайды</h2>

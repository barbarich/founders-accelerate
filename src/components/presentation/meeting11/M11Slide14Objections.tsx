...
const objections = [
  ...
  },
  {
    ...
    you: "«Окей. Что должно произойти у тебя к этому моменту, чтобы это стало приоритетом? Я могу записать звонок в календарь сразу на [дата через 12 недель], а пока ты ничего не платишь. Если к той дате условия сложатся — мы готовы.»",
  ...
  },
  {
    ...
    why: "One specific differentiator, не feature dump. Привяжи к ЕГО use-case из discovery.",
  },
  {
    n: "4",
    client: "«Надо посоветоваться с командой»",
    you: "«Конечно. Чтобы команде было проще решить — давай я приду на ваш внутренний звонок на 10 минут и отвечу на вопросы? Или: я подготовлю одностраничник специально под их роли — кому что показать. Что удобнее?»",
    why: "Не «жду решения 3 недели». Внедряешься в их процесс — становишься их sales-партнёром изнутри.",
  },
  {
    n: "5",
    ...
    why: "Запрос мини-демо на конкретике + честный escape-hatch. Снимает defensive-режим клиента.",
  },
];

export default function M11Slide14Objections() {

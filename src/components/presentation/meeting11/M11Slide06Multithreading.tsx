...
const stats = [
  { n: "5+", l: "среднее число stakeholders в B2B-сделке 2026 (Gartner)" },
  { n: "2.4×", l: "выше close rate при подключении 4+ stakeholders уже на discovery" },
  { n: "47%", l: "сделок умирают из-за одного blocker'а который появился в неделю 4" },
];

export default function M11Slide06Multithreading() {

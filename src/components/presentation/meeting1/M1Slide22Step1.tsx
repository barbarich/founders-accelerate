    ...
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      ...
      <div className="space-y-[24px] max-w-[1000px]">
        <div className="flex items-start gap-[16px]">
          ...
          <p className="text-[24px] text-[hsl(var(--slide-text)/0.85)] leading-[1.5]">Каждый открывает Perplexity.</p>
        </div>
        <div className="flex items-start gap-[16px]">
          ...
          <p className="text-[24px] text-[hsl(var(--slide-text)/0.85)] leading-[1.5]">Вводим запрос "Карта конкурентов" для своего продукта.</p>
        </div>
        <div className="flex items-start gap-[16px]">
          ...
          <p className="text-[24px] text-[hsl(var(--slide-text)/0.85)] leading-[1.5]">Смотрим результаты вместе. Я комментирую каждому: "вот этот — твой главный конкурент, изучи детально."</p>
        </div>
      </div>
    </div>
  );

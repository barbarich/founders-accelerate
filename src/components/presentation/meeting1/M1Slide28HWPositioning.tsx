export default function M1Slide28HWPositioning() {
  const tasks = [
    "Написать 3 варианта позиционирования",
    'Проверить тестом "мама"',
    "Выбрать лучший",
    "Быть готовым защитить на следующей встрече",
  ];

  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      <div className="flex items-center gap-[16px] mb-[16px]">
        <span className="font-mono text-[18px] text-[hsl(var(--slide-gold))] bg-[hsl(var(--slide-gold)/0.1)] px-[16px] py-[8px] rounded">30 мин</span>

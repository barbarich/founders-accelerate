// Санитайзенная FOM5-копия M10Slide09WorkshopAd (meeting10):
// убраны привязки к чужому продукту cohort-1 (Dira) и кросс-ссылка «M9».
...
const blocks = [
  ...
  {
    t: "Format",
    body: "Single image · Carousel · Video. Рекомендую микс: половина видео (вкл. аватар-ролики), половина статика. Andromeda сама выберет работающее.",
  },
  {
    t: "Media",
  ...
  },
  {
    ...
    body: "Выгода / результат / соц.доказательство. Не «приложение для X». А «500 человек получили результат за месяц».",
  },
  {
    t: "CTA",
    body: "Sign Up / Shop Now / Learn More / Send Message. Одно действие, без «или». Send Message — если основной CTA = чат в WhatsApp / Telegram.",
  },
  {
...
export default function FOM5SlideWSAd() {
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      ...
      <p className="text-[20px] text-[hsl(var(--slide-text)/0.88)] leading-[1.45] mb-[20px] max-w-[1600px]">
        Грузишь медиа из блока креативов сегодня. Тексты — Claude / GPT генерит за 5 минут. Главное — объём вариантов, не идеальность одного.
      </p>

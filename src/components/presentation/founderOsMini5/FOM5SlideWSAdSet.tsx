// Санитайзенная FOM5-копия M10Slide08WorkshopAdSet (meeting10):
// убрана привязка к чужому продукту cohort-1 (Dira.click) — обобщено.
import { useIsMobile } from "@/hooks/use-mobile";

const fields = [
  { label: "Conversion location", val: "Website (или Messenger — если основной CTA = диалог в чате)" },
...
export default function FOM5SlideWSAdSet() {

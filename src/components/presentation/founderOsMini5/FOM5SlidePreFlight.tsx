// Санитайзенная FOM5-копия M10Slide03PreFlightChecklist (meeting10):
// убраны кросс-ссылки на «M9» — в мини-формате блок креативов идёт в этой же сессии.
...
const items = [
  ...
  },
  {
    ...
    body: "Из блока креативов сегодня — половина статика, половина видео (+ аватар-ролики). Если креативов нет, на встрече нечего публиковать. Higgsfield, Nano Banana, Canva, HeyGen.",
  },
  {
    n: "06",
...
export default function FOM5SlidePreFlight() {
    ...
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[18px]">
        ...
        <p className="text-[8.5px] text-[hsl(var(--slide-text)/0.85)] leading-[1.45] mb-[6px]">
          Это твоя готовность к запуску. Если что-то не закрыто — закрываем прямо сейчас, до Ads Manager.
        </p>

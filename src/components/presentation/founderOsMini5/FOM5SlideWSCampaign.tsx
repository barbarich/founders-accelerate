// Санитайзенная FOM5-копия M10Slide07WorkshopCampaign (meeting10):
// убрана привязка к чужому продукту cohort-1 (Dira.click) — обобщено.
...
const steps = [
  ...
  },
  {
    ...
    body: "Buying type: Auction. Имя кампании по правилу: [Objective]_[Audience]_[Date] — например, Sales_Broad_10Jun.",
  },
  {
    n: "04",
  ...
  },
  {
    ...
    body: "Включаем, если продукт = жильё, кредит, работа, политика, соцтемы. Если это твоя тема — обязательно, иначе Meta заблокирует кампанию.",
  },
];

export default function FOM5SlideWSCampaign() {

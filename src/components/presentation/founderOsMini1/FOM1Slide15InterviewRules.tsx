...
export default function FOM1Slide15InterviewRules() {
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[10px] md:gap-[14px] max-w-[1700px] text-[10.5px] md:text-[18px]">
        {rules.map(([e, t, d], i) => (
          <div key={i} className="flex items-baseline gap-[10px]">
            <span className="text-[16px] md:text-[22px]">{e}</span>
            <p>
      ...
      <div className="mt-[14px] md:mt-[22px] border-l-[3px] pl-[14px] max-w-[1700px]" style={{ borderColor: "hsl(0 70% 60%)" }}>

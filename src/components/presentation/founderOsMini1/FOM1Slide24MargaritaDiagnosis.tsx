...
export default function FOM1Slide24MargaritaDiagnosis() {
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[12px] md:gap-[20px] max-w-[1800px] text-[10px] md:text-[16px]">
        <div className="bg-[hsl(var(--slide-bg-alt))] border border-[hsl(var(--slide-border)/0.3)] rounded-[10px] p-[10px] md:p-[16px]">
          <p className="text-[hsl(var(--slide-gold))] uppercase tracking-[0.2em] text-[8px] md:text-[12px]">Где сейчас</p>
        ...
        <div className="bg-[hsl(var(--slide-bg-alt))] border rounded-[10px] p-[10px] md:p-[16px]" style={{ borderColor: "hsl(0 70% 60% / 0.4)" }}>
          <p className="uppercase tracking-[0.2em] text-[8px] md:text-[12px]" style={{ color: "hsl(0 70% 60%)" }}>Что не работает</p>
          <ul className="mt-[6px] text-[hsl(var(--slide-text))] space-y-[3px]">
      ...
      <div className="mt-[10px] md:mt-[16px] border-l-[3px] border-[hsl(var(--slide-gold))] pl-[12px] max-w-[1800px] text-[10px] md:text-[16px]">

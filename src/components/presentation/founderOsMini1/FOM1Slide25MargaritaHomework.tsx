...
const tasks = [
  ["Выбрать одно направление", "Из четырёх. Решение к среде следующей недели. Фиксируем письменно. Возвращаться к остальным нельзя."],
  ...
  ["К среде следующей недели в Telegram", "Новое позиционирование + список 5 компаний для pilot conversations + один из тестов: есть ли реальная B2B-модель (subscription per company / per seat / outcome-based — не реклама)."],
];

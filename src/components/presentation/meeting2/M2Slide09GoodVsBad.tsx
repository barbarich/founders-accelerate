...
export default function M2Slide09GoodVsBad() {
  const examples = [
    {
      ...
      good: '"Slack для строителей — чат, задачи и фото объекта в одном приложении"',
    },
    {
      bad: '"AI-решение для бизнес-аналитики нового поколения"',
      good: '"Даём малому бизнесу отчёт по продажам за 30 секунд — без аналитика и Excel"',
    },
    {
      bad: '"Комплексная EdTech-платформа для корпоративного обучения"',
      good: '"MetaMinder создаёт курс для сотрудников за 5 минут с помощью AI — без методологов"',
    },
  ];
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      ...
      <h2 className="font-display text-[60px] font-bold text-[hsl(var(--slide-text))] leading-[1.1] mb-[40px]">Плохо vs Хорошо</h2>

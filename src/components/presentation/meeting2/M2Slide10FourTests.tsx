  ...
  const formats = [
    {
      icon: "🖥️",
      channel: "Лендинг",
      example: "HR-менеджеры создают курс для сотрудников за 5 минут — без методологов",
      tip: "Конкретный результат + «без» в заголовке",
    },
    {
      icon: "💬",
      channel: "Холодное сообщение",
      example: "Привет! Видел что вы набираете людей. Мы помогаем HR-ам запускать onboarding-курсы за 5 минут вместо 2 недель. Интересно глянуть?",
      tip: "Контекст + результат + лёгкий вопрос",
    },
    {
      icon: "🎤",
      channel: "Питч (30 секунд)",
      example: "Когда компания растёт, HR тратит недели на создание курсов. MetaMinder делает это за 5 минут с AI. Уже 50 компаний используют.",

...
export default function M2Slide25Homework() {
  const tasks = [
    {
      time: "2–3 ч",
      title: "Финальный список фич MVP",
      items: [
        "Таблица: что делает / что НЕ делает",
        "Для каждой фичи: почему она нужна (какую боль закрывает)",
        "Приоритизация по матрице влияние × сложность",
      ],
    },
    {
      time: "2–3 ч",
      ...
      items: [
        "Показать прототип/MVP 3 людям из целевой аудитории",
        "Записать реакцию: что понятно, что нет, что бесит",
        "Спросить: «Сколько бы заплатили за это?»",
      ],
    },
    {
      time: "1 ч",
      title: "Список доработок",
      items: [
        "Что починить по результатам тестов",
        "Что добавить (только из квадрата «Делать первым»)",
        "Что убрать (если после тестов стало очевидно)",
      ],
    },
  ];

      ...
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[24px]">
        ...
        <div className="space-y-[6px]">
          {[
            ...
            { q: "Можно ли убрать что-то и результат останется?", a: "Если убрал и клиент всё ещё получает результат — убирай" },
          ].map((item, i) => (
    ...
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      ...
      <div className="space-y-[16px] max-w-[1000px]">
        {[
          ...
          { q: "Какой ОДИН сценарий ведёт к результату?", a: "Пользователь пришёл → сделал X → получил результат. Точка." },
          { q: "Можно ли убрать что-то и результат останется?", a: "Если убрал и клиент всё ещё получает результат — убирай. Это и есть MVP." },
        ].map((item, i) => (

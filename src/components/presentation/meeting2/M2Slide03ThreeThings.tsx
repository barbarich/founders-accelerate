...
export default function M2Slide03ThreeThings() {
  const items = [
    { num: "01", icon: "💬", title: "Доточим позиционирование", text: "Формула, которая продаёт за 5 секунд — без воды и абстракций" },
    { num: "02", icon: "💰", title: "Определим цену", text: "Модель монетизации, психология цены, первый прайс" },
    { num: "03", icon: "🛠️", title: "Отрежем лишнее в MVP", text: "Что строить первым, что не строить никогда" },
  ];

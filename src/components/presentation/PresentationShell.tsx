...
const timelineSlides = [
  ...
  { period: "2024–н.в.", title: "MetaMinder", subtitle: "B2B SaaS · EdTech · CEO / CPO / CMO", description: "AI-платформа для обучения сотрудников. Сам выполняю роли CEO, CPO и CMO — настроил процессы и автоматизировал с помощью AI. От идеи до первых платящих B2B клиентов за 7 месяцев.", highlight: "0 → платящие клиенты за 7 мес.", image: metaminder1 },

...
const timelineSlides = [
  ...
  { period: "2018–2021", title: "SI DI Perapuff", subtitle: "E-commerce · Экзит", description: "Нашёл нишу для уникального продукта в Израиле. Анализ рынка, построение онлайн-продаж. 5000+ товаров за 1.5 года. Продал как готовый бизнес.", highlight: "5000+ продаж → экзит", image: perapuff1 },
  ...
  { period: "2023–2024", title: "ForexTester", subtitle: "FinTech · B2C · CEO", description: "Кризис-менеджмент компании с $3M ARR и 16 годами на рынке. Создал 3 новых продукта с нуля — +$1M ARR за 4 месяца.", highlight: "+$1M ARR за 4 месяца", image: forextester1 },

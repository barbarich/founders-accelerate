...
const timelineSlides = [
  ...
  { period: "2018–2021", title: "SI DI Perapuff", subtitle: "E-commerce · Экзит", description: "Нашёл нишу для уникального продукта в Израиле. Анализ рынка, построение онлайн-продаж. 5000+ товаров за 1.5 года. Продал как готовый бизнес.", highlight: "5000+ продаж → экзит", image: perapuff1, imageContain: true },

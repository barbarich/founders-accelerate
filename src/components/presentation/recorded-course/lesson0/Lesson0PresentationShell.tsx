...
export const slideNames = [
  ...
  "Правда 2 · Build in public без аудитории",
  "Правда 3 · Meta без событий = мусор",
  "Правда 4 · Кофаундер замедляет в 2026",
...
export default function Lesson0PresentationShell({ backTo = "/admin/meetings" }: { backTo?: string } = {}) {

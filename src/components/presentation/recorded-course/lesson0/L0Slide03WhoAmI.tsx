    ...
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col">
        ...
        <div className="flex-1 flex flex-col px-[28px] -mt-[30px] relative z-10">
          <p className="text-[10px] uppercase tracking-[0.2em] text-[hsl(var(--slide-gold))] font-medium mb-[4px]">Кто я</p>
          <h2 className="text-[26px] font-bold text-[hsl(var(--slide-text))] leading-tight mb-[4px]">Михаэль Барбарич</h2>
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-[100px]">
        <p className="text-[16px] uppercase tracking-[0.2em] text-[hsl(var(--slide-gold))] font-medium mb-[16px]">Кто я</p>
        <h2 className="text-[64px] font-bold text-[hsl(var(--slide-text))] leading-tight mb-[12px]">Михаэль Барбарич</h2>

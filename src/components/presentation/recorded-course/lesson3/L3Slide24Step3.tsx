...
export default function L3Slide24Step3() {
  const steps = [
    ...
    { time: "3–6", action: "Цена = 1-10% от результата клиента. Выберите модель и запишите тарифы" },
    ...
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      ...
      <div className="space-y-[20px] max-w-[1100px]">
        {[
          ...
          { time: "3–6 мин", action: "Цена = 1-10% от результата клиента. Выберите модель монетизации и запишите тарифы" },

...
export default function L5SlideStoryShift() {
    ...
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[20px]">
        ...
        <div className="grid grid-cols-2 gap-[6px] mb-[8px]">
          {sides.map((s, i) => (
            <div key={i} className="rounded-[6px] px-[9px] py-[7px] border" style={{ backgroundColor: s.bgColor, borderColor: s.borderColor }}>

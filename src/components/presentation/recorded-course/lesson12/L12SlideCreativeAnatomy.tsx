...
const parts = [
  ...
  { n: "03", t: "Proof · параллельно с value", body: "Цифра, лицо, лого. «Используют 200+ команд от Vercel до Linear». Без proof — это «ещё один стартап»." },
  { n: "04", t: "CTA · последний кадр", body: "Один глагол + один результат. «Скачай чек-лист» лучше, чем «Узнать больше». Кнопка одна, не три." },
];

export default function L12SlideCreativeAnatomy() {
    ...
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[18px]">
        ...
        <h2 className="font-display text-[19px] font-bold text-[hsl(var(--slide-text))] leading-[1.1] mb-[6px]">
          Четыре куска <span className="text-[hsl(var(--slide-gold))]">в любом объявлении</span>
        </h2>
        <p className="text-[8.5px] text-[hsl(var(--slide-text)/0.85)] leading-[1.45] mb-[6px]">
          Если в креативе нет хоть одного — конверсия проседает в 3–10 раз. Это до того, как открыть Ads Manager.
        </p>
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      ...
      <p className="text-[20px] text-[hsl(var(--slide-text)/0.88)] leading-[1.45] mb-[24px] max-w-[1600px]">
        Если в креативе нет хоть одного из четырёх — конверсия проседает в 3–10 раз. Работает одинаково для картинки и видео, для B2B и B2C.
      </p>

...
const playbook = [
  ...
  { tag: "ПОСЛЕ 7 ДНЕЙ", t: "Резать и доливать", body: "Креативы с Below Average — выключаешь. На winning ad set доливаешь бюджет на +20% раз в 3-4 дня, не чаще." },
...
export default function L12Slide11WorkshopAfterLaunch() {
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      <p className="text-[18px] uppercase tracking-[0.2em] text-[hsl(var(--slide-gold))] font-medium mb-[14px]">
        Воркшоп · Шаг 6 · После запуска · что смотреть и когда что менять
      </p>

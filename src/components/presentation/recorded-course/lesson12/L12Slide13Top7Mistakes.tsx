...
const mistakes = [
  ...
  { n: "07", t: "Без warmup сразу $100/день", body: "Новый ad account, нет истории — Meta флажит как fraud. Стартуй с $20–30 первую неделю, потом масштабируй на +20% раз в 3-4 дня." },
];

export default function L12Slide13Top7Mistakes() {

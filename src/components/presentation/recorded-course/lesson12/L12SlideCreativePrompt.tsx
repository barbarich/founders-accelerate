...
const promptLines = [
  ...
  "2. Позиционирование одной фразой: [ВСТАВЬ_ПОЗИЦИОНИРОВАНИЕ]",
...
export default function L12SlideCreativePrompt() {
    ...
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[18px] py-[16px]">
        <p className="text-[10px] uppercase tracking-[0.2em] text-[hsl(var(--slide-gold))] font-medium mb-[4px]">
          Готовый промпт · 30 концептов за 5 минут
        </p>
        ...
        <span role="button" tabIndex={0} onClick={handleCopy} onKeyDown={(e) => { if (e.key === "Enter" || e.key === " ") handleCopy(e); }} className="mt-[6px] flex items-center gap-[4px] bg-[hsl(var(--slide-gold)/0.1)] border border-[hsl(var(--slide-gold)/0.2)] rounded-[5px] px-[8px] py-[4px] self-start cursor-pointer">

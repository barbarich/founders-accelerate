...
const blocks = [
  ...
  {
    t: "CTA",
    body: "Sign Up / Shop Now / Learn More / Send Message. Одно действие, без «или». Send Message - если целевое действие диалог в мессенджере (click-to-message).",
  },
  {
    ...
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[18px]">
        <p className="text-[10px] uppercase tracking-[0.2em] text-[hsl(var(--slide-gold))] font-medium mb-[6px]">
          Воркшоп · Шаг 4 · Ad · Dynamic Creative
        </p>
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      ...
      <p className="text-[20px] text-[hsl(var(--slide-text)/0.88)] leading-[1.45] mb-[20px] max-w-[1600px]">
        Грузишь медиа, которые собрал в блоке «Креативы». Тексты — Claude / GPT генерит за 5 минут. Главное — объём вариантов, не идеальность одного.
      </p>

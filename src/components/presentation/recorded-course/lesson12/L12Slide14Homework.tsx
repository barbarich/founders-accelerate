...
const tasks = [
  ...
  { n: "3", t: "Подготовить 5 новых креативов", d: "Параллельно делай следующую партию. К L13 будет понятно, какие углы работают — заливаем свежие в том же стиле." },
  { n: "4", t: "Принести скриншот Reports", d: "К L13 скриншот: CPM · CTR · CPA · 3 ranking-колонки. В следующих уроках разбираем что данные говорят про твой продукт и креатив." },
];

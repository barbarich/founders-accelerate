...
const tasks = [
  ...
  {
    num: "4",
    title: "Запишите демо продукта - 5 минут",
    desc: "Курс самостоятельный, живого демо-дня нет. Запишите короткое видео (Loom или телефон) - это ваша проверка и готовый материал для соцсетей.",
    checklist: [
      ...
      "Выложить видео в соцсети или прислать на разбор",
    ],
  },
];

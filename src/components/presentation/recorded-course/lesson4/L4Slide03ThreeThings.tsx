...
export default function L4Slide03ThreeThings() {
  const items = [
    { num: "01", icon: "🧩", title: "Прототип на цикле фидбэка", text: "Собери, покажи живым людям, доработай по фидбэку - и так по кругу, пока не ясно что, кому и зачем" },
    { num: "02", icon: "🖥️", title: "Лендинг из ваших фреймворков", text: "Формула результата + боли из custdev = готовый лендинг за 30 минут" },
    { num: "03", icon: "⚡", title: "Подключаем без разработчика", text: "Авторизация, оплата, аналитика — всё через AI за один промпт" },
  ];

...
import L8Slide03ShockNumber from "./L8Slide03ShockNumber";
import L8Slide04FourReasons from "./L8Slide04FourReasons";
import L8Slide05JargonTranslator from "./L8Slide05JargonTranslator";
import L8BlockHeader from "./L8BlockHeader";
import L8Slide06Principle from "./L8Slide06Principle";
import L8Slide10NotificationLast from "./L8Slide10NotificationLast";
import L8Slide11Mechanic1Streak from "./L8Slide11Mechanic1Streak";
import L8Slide12Mechanic2Unfinished from "./L8Slide12Mechanic2Unfinished";
import L8Slide13Mechanic3Social from "./L8Slide13Mechanic3Social";
import L8Slide14Mechanic4FreshContent from "./L8Slide14Mechanic4FreshContent";
import L8Slide15Mechanic5Deadline from "./L8Slide15Mechanic5Deadline";
import L8Slide13bWorkshop from "./L8Slide13bWorkshop";
import L8Slide16NoCodeStack from "./L8Slide16NoCodeStack";
import L8Slide17AIPrompt from "./L8Slide17AIPrompt";
import L8Slide18LiveDemo from "./L8Slide18LiveDemo";
import L8Slide18bMessageFromInsight from "./L8Slide18bMessageFromInsight";
import L8Slide20RetentionStackFree from "./L8Slide20RetentionStackFree";
import L8Slide22ReactivationInsights from "./L8Slide22ReactivationInsights";
import L8Slide24Homework from "./L8Slide24Homework";
import L8Slide25NextWeek from "./L8Slide25NextWeek";
...
export function getSlideContent(index: number) {
  switch (index) {
    ...
    case 2: return <L8Slide03ShockNumber />;
    case 3: return <L8Slide04FourReasons />;
    case 4: return <L8Slide05JargonTranslator />;
    case 5: return <L8Slide06Principle />;
    case 6: return <L8BlockHeader blockNumber={2} title="5 механик возврата" subtitle="встроенных в продукт" />;
    case 7: return <L8Slide10NotificationLast />;
    case 8: return <L8Slide11Mechanic1Streak />;
    case 9: return <L8Slide12Mechanic2Unfinished />;
    case 10: return <L8Slide13Mechanic3Social />;
    case 11: return <L8Slide14Mechanic4FreshContent />;
    case 12: return <L8Slide15Mechanic5Deadline />;
    case 13: return <L8Slide13bWorkshop />;
    case 14: return <L8BlockHeader blockNumber={3} title="Wow-инструменты без кода" />;
    case 15: return <L8Slide16NoCodeStack />;
    case 16: return <L8Slide17AIPrompt />;
    case 17: return <L8Slide18LiveDemo />;
    case 18: return <L8Slide18bMessageFromInsight />;
    case 19: return <L8BlockHeader blockNumber={4} title="Стек и чек-лист" subtitle="запусти всё за вечер" />;
    case 20: return <L8Slide20RetentionStackFree />;
    case 21: return <L8BlockHeader blockNumber={5} title="Реактивация и задание" />;
    case 22: return <L8Slide22ReactivationInsights />;
    case 23: return <L8Slide24Homework />;
    case 24: return <L8SlideLessonSummary />;
    case 25: return <L8Slide25NextWeek />;
    default: return null;
  }
}

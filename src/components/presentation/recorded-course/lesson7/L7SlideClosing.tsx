...
export default function L7SlideClosing() {
    ...
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[24px]">
        ...
        <h2 className="font-display text-[32px] font-bold text-[hsl(var(--slide-text))] leading-[1.1] mb-[20px] tracking-[-0.02em]">
          В Урок 8: <span className="text-[hsl(var(--slide-gold))]">3-экранная onboarding-воронка</span>
        </h2>
        <p className="text-[12px] text-[hsl(var(--slide-text-muted))] leading-[1.6] mb-[16px]">
          Теперь у тебя есть Aha. Дальше — детальная механика трёх экранов, которые ведут к нему.
        </p>

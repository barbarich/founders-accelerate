...
const insights = [
  ...
  },
  {
    ...
    body: "100-150 в лонглисте, не 10. Из них → 50-70 в аутриче → 15-25 встреч → 1-3 term sheet. Это математика, не магия — та же воронка, что и в продажах. Меньше = нет шансов.",
  },
  {
    num: "4",
    title: "Term sheet — это договор, не формальность",
    body: "Каждая строчка — это либо твои деньги, либо твой контроль над компанией. Не понимаешь пункт — не подписывай, пока не спросишь юриста. И не бери первое предложение: переговоры — это нормально.",
  },
  {
    num: "5",
...
export default function L15SlideLessonSummary() {

...
const items = [
  ...
  { n: "2", t: "Pitch deck v1", d: "Промпт с этого урока — на выходе готовый HTML-дек. Или Pitch.com / Figma, если хочешь вручную. Не идеально — первая версия" },
  { n: "3", t: "Лонглист 100+ инвесторов", d: "AngelList + Crunchbase: фаундеры из похожих ниш + angels с твоей географии. CSV с именами и контактами — воронка из лекции требует именно такой размер" },
  { n: "4", t: "5 warm intros запрошено", d: "Найди 5 фаундеров с твоего круга, кто знает кого-то из списка. Попроси intro" },

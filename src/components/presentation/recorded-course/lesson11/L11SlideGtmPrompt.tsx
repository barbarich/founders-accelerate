...
const promptLines = [
  ...
  "2. ГДЕ ОНИ РЕАЛЬНО СИДЯТ - назови КОНКРЕТНЫЕ места под мою нишу и гео: реальные типы",
  ...
  "3. ПОЗИЦИЯ - одна фраза, под которую они кликнут, с учётом того, что они уже пробовали.",
  "4. КАНАЛЫ ПОД МОЙ БЮДЖЕТ - выбери 1-2 канала (концентрация), не десять.",
  ...
  "5. ПЕРВЫЕ 3 ХОДА НА ЭТОЙ НЕДЕЛЕ - с готовыми словами: текст первого сообщения/DM,",
  "   черновик первого поста, к кому и куда. Чтобы я скопировал и сделал сегодня.",
  "6. ПЛАН НА 30 ДНЕЙ - по неделям: канал × активность × сколько раз × метрика × цель",
  "   в цифрах (напр. «20 сообщений → 5 ответов → 1 продажа»).",
  "7. СИГНАЛЫ - когда удваивать канал, когда убивать, когда включать платный трафик",
  "   и партнёрства.",
  "",
  ...
  "□ План на 30 дней с метриками и целями в цифрах",

...
const industry = [
  ...
  { num: "0.05 сек", t: "за столько человек решает, остаться на странице или уйти — ещё до того, как прочтёт хоть слово", src: "Lindgaard et al." },
  { num: "88%", t: "AI-продуктов не доходят до продакшена из-за слабой упаковки и пустого онбординга", src: "CIO · 2025" },
];

const myScore = [
  { num: "Сотни", t: "клиентов MetaMinder на всех континентах — построено без рекламного бюджета, через личный нетворк и упаковку" },

...
const examples = [
  ...
  { brand: "Forex Tester", body: "Помогает трейдерам тестировать стратегию на 20+ годах реальной истории без риска и без месяцев ожидания, через симулятор, который прокручивает рынок бар за баром, в отличие от демо-счёта, где ждёшь реального времени, или бэктеста вслепую по одним цифрам." },

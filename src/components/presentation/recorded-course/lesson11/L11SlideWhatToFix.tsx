...
const quadrants = [
  ...
  { x: "Low visitors", y: "High activation", verdict: "Чини маркетинг", color: "text-[hsl(var(--slide-gold))]", body: "Продукт хороший — те кто приходят, активируются. Проблема в каналах: мало трафика. L12-L13 решают." },
  ...
  { x: "High visitors", y: "High activation, low retention", verdict: "Чини retention", color: "text-[hsl(var(--slide-gold))]", body: "Приходят, активируются, но не возвращаются. Onboarding отрабатывает, цикл возврата — нет. L9 решает." },
];

export default function L11SlideWhatToFix() {

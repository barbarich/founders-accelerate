...
const steps = [
  ...
  { n: "3", name: "Как заходим", goal: "адресно", out: "пишем конкретному человеку и знаем, почему ему это актуально. Свежий повод у клиента — бонус, который усиливает письмо" },
  { n: "4", name: "Первый звонок", goal: "потребность + шаг", out: "это не кастдев: проверяем, что потребность реальна, и договариваемся о следующем шаге — ближе к сделке" },
...
export default function L13Slide03MotionMap() {

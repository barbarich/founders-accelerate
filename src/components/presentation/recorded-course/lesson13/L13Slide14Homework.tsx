...
const tasks = [
  ...
  { n: "3", t: "Подготовить 5 новых креативов", d: "Параллельно делай следующую партию. К L14 будет понятно, какие углы работают — заливаем свежие в том же стиле." },
  { n: "4", t: "Принести скриншот Reports", d: "К L14 скриншот: CPM · CTR · CPA · 3 ranking-колонки. В следующих уроках разбираем что данные говорят про твой продукт и креатив." },
];

const b2b = {
  who: "B2B trek · Maker E",
  body: "Пришли мне к концу недели: pitch + offer + список 50 target accounts. На L14 разбираем твой стек — Apollo + Instantly + LinkedIn outreach с нуля.",
};

const dira = {
  who: "WhatsApp-бот аренды",
  body: "Включи Special Ad Category = Housing. Тестовая кампания на click-to-WhatsApp на 1–2 района. Бюджет $15/день. К L14 покажешь первые сообщения.",
};

export default function L13Slide14Homework() {

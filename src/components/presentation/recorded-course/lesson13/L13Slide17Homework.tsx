...
const tasks = [
  ...
  { n: "6", t: "5-минутная презентация готова к L14", d: "Проблема (1 мин) · решение (1 мин) · результат (1 мин) · команда и запрос (1 мин) · призыв к действию (1 мин). Потренируй вслух 3 раза." },
];

export default function L13Slide17Homework() {

...
const reasons = [
  ...
  { n: "4", title: "Обиделись", body: "Ошибка, сбой, навязчивый push, неловкое первое знакомство.", fix: "Чек-лист первой недели + одно тёплое письмо." },
];

export default function L9Slide04FourReasons() {

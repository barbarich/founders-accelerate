...
export default function L1Slide26HWCompetitors() {
  const tasks = [
    ...
    "Проанализировать нишу через Deep Research",
    ...
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[140px]">
      ...
      <div className="space-y-[14px] max-w-[1100px]">
        {[
          ...
          "Проанализировать нишу через Deep Research (ChatGPT / Claude / Gemini) — запустить промпт для общего анализа рынка, затем загрузить отчёт в NotebookLM и послушать подкастом",

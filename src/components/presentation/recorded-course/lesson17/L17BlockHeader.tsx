...
export default function L17BlockHeader({ blockNumber, title, subtitle }: Props) {
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex items-center justify-center">
      <div className="text-center">
        ...
        <h2 className="font-display text-[64px] font-bold text-[hsl(var(--slide-text))] leading-tight">{title}</h2>
        {subtitle && <p className="text-[26px] text-[hsl(var(--slide-text-muted))] mt-[24px]">{subtitle}</p>}

...
const items = [
  { n: "1", t: "Определи свою точку: А, Б или В", d: "Одну. Весь остальной план ты читаешь и выполняешь только через неё" },
  { n: "2", t: "Пройди список «что на руках»", d: "Выпиши, чего у тебя реально нет, и закрой это в первую неделю. Новое не начинаешь" },
  { n: "3", t: "Выбери одно число месяца", d: "Разговоры, оплаты или стоимость клиента - смотря какая у тебя точка. Заведи таблицу, куда будешь его писать" },
  { n: "4", t: "Собери список из 10 имён", d: "Клиенты, партнёры, креаторы или треды - смотря какой канал выбрал в уроке 16" },
  { n: "5", t: "Поставь в календарь три блока", d: "Понедельник 30 минут, каждый день час, пятница 30 минут. Именно в календарь, а не в голову" },
  { n: "6", t: "Сделай первое касание за 48 часов", d: "Одно. Сегодня или завтра. Пока мотивация от этого урока ещё не остыла" },
  { n: "7", t: "Напиши мне через 30 дней", d: "Что получилось, с цифрами. Это твой способ не пропустить месяц" },
];
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[110px] py-[40px]">
      ...
      <h2 className="font-display text-[44px] font-bold text-[hsl(var(--slide-text))] leading-[1.1] mb-[26px] tracking-[-0.01em]">
        7 пунктов - <span className="text-[hsl(var(--slide-gold))]">и ты в работе</span>
      </h2>

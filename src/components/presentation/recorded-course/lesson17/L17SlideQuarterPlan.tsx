...
const months = [
  {
    ...
    gate: "Идёшь дальше, когда есть хотя бы 1 оплата или 3 предоплаты.",
  ...
  },
  {
    ...
    gate: "Идёшь дальше, когда 5 и больше оплат и ты можешь объяснить, откуда пришла каждая.",
  ...
  },
  {
    ...
    gate: "Итог квартала: один рабочий канал и понимание, сколько стоит каждый клиент.",

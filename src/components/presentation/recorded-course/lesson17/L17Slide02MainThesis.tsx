    ...
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[24px]">
        ...
        <h2 className="font-display text-[26px] font-bold text-[hsl(var(--slide-text))] leading-[1.15] mb-[16px] tracking-[-0.02em]">
          Дальше решает не знание. Дальше решает то, <span className="text-[hsl(var(--slide-gold))]">сколько недель ты продолжишь после того, как станет скучно</span>.
        </h2>
        <p className="text-[11.5px] text-[hsl(var(--slide-text-muted))] leading-[1.6] mb-[14px]">
          Всё, что нужно знать, чтобы довести продукт до платящих, ты уже знаешь. У меня за спиной два выхода, и ни разу решающим не было знание - решало то, что я не останавливался на третьем тихом месяце.
        </p>
        <div className="bg-[hsl(var(--slide-gold)/0.08)] border-l-2 border-[hsl(var(--slide-gold))] rounded-[4px] px-[10px] py-[8px]">
          <p className="text-[10.5px] text-[hsl(var(--slide-text))] leading-[1.5]">
            Этот урок - не новая теория. Это план: что делать в ближайшие 30 и 90 дней, начиная с завтрашнего утра.
          </p>
        </div>
      </div>
    );

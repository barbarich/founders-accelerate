...
const insights = [
  ...
  {
    num: "3",
    title: "Качественные интервью сначала, опросы потом",
    body: "20-30 интервью — понимаешь суть проблемы. Потом опрос 100-500 человек — проверяешь массовость. Начнёшь с опросов — спросишь не о том.",
  },
  {
    num: "4",

...
export default function L2Slide03ThreeThings() {
  const items = [
    { num: "01", icon: "📊", title: "Соберём количественные данные", text: "Опрос 100+ человек: понять суть и масштаб проблемы, родить гипотезы. Особенно сильно, если у тебя уже есть юзеры." },
    { num: "02", icon: "🎙️", title: "Проведём кастдев-интервью", text: "10 живых разговоров — лично проверим, та ли это боль и за что готовы платить." },
    { num: "03", icon: "✅", title: "Примем решение PASS / FAIL", text: "Хватает данных, чтобы строить — или переформулировать гипотезу." },
  ];

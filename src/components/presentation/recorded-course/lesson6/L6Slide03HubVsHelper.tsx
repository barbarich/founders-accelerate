...
const story = [
  "Основатель построил весь продукт в Lovable за 3 недели — выглядело впечатляюще",
  "Дошёл до задачи «добавить оплату по подписке через Stripe»",
  "Lovable начал ломать то, что уже работало вчера",
  "На выходе — 10 000 строк кода, в которых никто не может разобраться",
  "Перенос в Claude Code означал переписать почти всё с нуля",
];

...
- Фронт: [например: Next.js + Tailwind, или Lovable, или просто HTML]
- Бэкенд / база: [например: Supabase, или Firebase, или ничего пока]
...
- Я фаундер, не разработчик. Объясняй простыми словами.
- Перед любой задачей сначала покажи план — какие файлы трогаешь, что меняется.
...
- Все секретные ключи — только в .env, никогда в коде.
...
- Не угадывай. Спроси меня одним коротким вопросом и жди ответа.
- Лучше остановиться и спросить, чем сделать неправильно и переделывать.`;

...
1. Безопасность
   ...
   — Защищены ли данные юзеров от чужих глаз?
   — Есть ли защита от спама?

2. Что может сломаться
   — Что если юзер введёт пустое поле?
   — Что если придёт двойная оплата?
   — Что если оборвётся посередине?
...
const flow = [
  ...
  { from: "Codex / Gemini", to: "Свежий взгляд на план" },
  { from: "Назад в Claude", to: "Правки + код" },
];
    ...
    return (
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[14px]">
        ...
        <p className="text-[7.5px] text-[hsl(var(--slide-text-muted))] mb-[4px] leading-[1.4]">
          Другая модель = другой взгляд. То, что Claude считает «нормально», Gemini или Codex могут увидеть как риск. Лучшая страховка от багов.
        </p>
  ...
  return (
    <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col justify-center px-[80px]">
      ...
      <p className="text-[18px] text-[hsl(var(--slide-text-muted))] mb-[14px] max-w-[1500px] leading-[1.45]">
        Другая модель = другой взгляд. То, что Claude считает «нормально», Gemini или Codex могут увидеть как риск. Это лучшая дешёвая страховка от багов в проде.
      </p>
      ...
      <div className="grid grid-cols-[1.6fr_1fr] gap-[20px] max-w-[1700px]">
        <div>
          <p className="text-[14px] uppercase tracking-[0.18em] text-[hsl(var(--slide-gold))] font-bold mb-[8px]">Промпт-ревью · вставь в Codex / Gemini</p>

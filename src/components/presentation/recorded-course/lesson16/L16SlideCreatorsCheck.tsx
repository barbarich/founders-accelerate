...
const checks = [
  { t: "Посмотри график роста", d: "Сервис Social Blade, бесплатно. Если подписчики выросли на 15% за неделю без вирусного видео - это накрутка." },
  { t: "Прогони через сервис проверки", d: "Modash или HypeAuditor с прошлого слайда покажут долю живых подписчиков одной кнопкой. Больше 25% подозрительных - проходим мимо." },
  { t: "Почитай комментарии", d: "Если больше 15% - это одно слово или просто эмодзи, аудитория куплена. Смотри, задают ли вопросы по сути." },
  { t: "Попроси скриншот статистики", d: "Охваты и географию аудитории. Отказ показать - главный тревожный знак, честные блогеры дают сразу." },
];

...
const insights = [
  ...
  {
    num: "5",
    title: "Каталоги усиливают, а находят через чужие подборки",
    body: "Каталог не приведёт первого клиента тому, у кого их ноль. А вот попасть в сторонние списки «лучшие X» стоит: это почти половина того, что цитирует ChatGPT.",
  },
];

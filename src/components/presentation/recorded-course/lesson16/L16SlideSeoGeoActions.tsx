...
const actions = [
  ...
  { t: "Найди 10-15 чужих подборок «лучшие X»", d: "В своей нише. Напиши автору: вот продукт, вот чем отличается, можно добавить? Это чаще всего цитирует ChatGPT, отвечая «что выбрать»." },

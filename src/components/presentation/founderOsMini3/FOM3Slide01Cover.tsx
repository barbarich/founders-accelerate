...
export default function FOM3Slide01Cover() {
      ...
      <div className="w-full h-full bg-[hsl(var(--slide-bg))] flex flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-[28px] h-full">
          ...
          <p className="uppercase tracking-[0.2em] text-[hsl(var(--slide-gold))] text-[10px] font-medium mb-[10px]">
            The Founders Circle · Сессия 3 из 6
          </p>
          <h1 className="font-display text-[26px] font-bold text-[hsl(var(--slide-text))] leading-[1.1] tracking-[-0.02em]">
            Build & Land.<br />
            <span className="text-[hsl(var(--slide-gold))]">Собираем MVP</span> и лендинг за один вечер.
          </h1>
          <div className="mt-[18px] space-y-[8px] text-[12px] text-[hsl(var(--slide-text))] leading-[1.5]">
            <p><span className="text-[hsl(var(--slide-gold))]">→</span> 120 минут · 2 фаундера · строим вживую</p>
            <p><span className="text-[hsl(var(--slide-gold))]">→</span> два навыка сегодня: build-стек + анатомия лендинга</p>
            <p><span className="text-[hsl(var(--slide-gold))]">→</span> MUST HAVE и цена из С2 — становятся ТЗ</p>
          </div>
        </div>
        <FOM3Footer slide={1} />
      </div>
      ...
      <div className="relative z-10 flex flex-col justify-center px-[140px] max-w-[1500px] h-full">
        ...
        <div className="mt-[44px] grid grid-cols-3 gap-[32px] max-w-[1500px]">
          <div className="border-l-2 border-[hsl(var(--slide-gold))] pl-[20px]">
            ...
            <p className="text-[22px] text-[hsl(var(--slide-text))] leading-[1.35]">120 минут · строим вживую</p>
          </div>
          <div className="border-l-2 border-[hsl(var(--slide-gold))] pl-[20px]">
            <p className="text-[14px] uppercase tracking-[0.15em] text-[hsl(var(--slide-gold))] mb-[8px]">2 навыка</p>
            <p className="text-[22px] text-[hsl(var(--slide-text))] leading-[1.35]">build-стек + анатомия лендинга</p>
          </div>
          <div className="border-l-2 border-[hsl(var(--slide-gold))] pl-[20px]">
            <p className="text-[14px] uppercase tracking-[0.15em] text-[hsl(var(--slide-gold))] mb-[8px]">ТЗ</p>
            <p className="text-[22px] text-[hsl(var(--slide-text))] leading-[1.35]">MUST HAVE и цена из С2</p>
          </div>
        </div>
      </div>
      <FOM3Footer slide={1} />

...
const tasks = [
  ...
  ["К С4 в Telegram до встречи", "Ссылка на лендинг (живой домен) · ссылка на MVP · список из 3-5 точек, где спотыкались живые люди. Без этого блок Onboarding не работает."],
];

...
import MiniCourseSuccess from "./pages/MiniCourseSuccess";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/mini-course/success" element={<MiniCourseSuccess />} />
          <Route path="/:lang/mini-course/success" element={<MiniCourseSuccess />} />

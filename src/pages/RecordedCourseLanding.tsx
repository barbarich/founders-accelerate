...
function TrustStrip() {
  ...
  return (
    <div className="mcl-trust">
      ...
      <div className="mcl-trust-text"><strong>{count}</strong> фаундеров уже на программе</div>
...
function Consultations() {
  return (
    <section className="rcl-consult">
      <div className="mcl-container">
        <div className="mcl-section-label">Тариф с работой лично</div>
        <h2 className="mcl-section-title">3 личные консультации <em>1:1 со мной</em></h2>
        <p className="mcl-section-intro">
          В тарифе за $997 ты проходишь программу не один. Три часовые консультации по видеосвязи — по мере твоего продвижения по курсу, ровно тогда, когда они нужнее всего. Это не созвоны «вообще» — мы разбираем твой продукт.
        </p>
        ...
        <div className="rcl-consult-note">
          <strong>Почему лично это меняет всё:</strong> запись даёт тебе метод. Консультация даёт тебе ответ на твой конкретный вопрос про твой конкретный продукт — то, чего не даст ни один видеоурок. Час со мной обычно стоит дороже, чем разница между тарифами.
        </div>
      </div>
    </section>
  );

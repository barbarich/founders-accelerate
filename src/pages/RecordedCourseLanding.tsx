...
const PROGRAM: readonly Month[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { num: "16", title: "Каналы продвижения: что ещё работает", desc: "Партнёрства, инфлюенсеры, комьюнити, каталоги и видимость в AI-поиске. Выбираешь два и запускаешь. Финал программы." },
    ],
  },
];

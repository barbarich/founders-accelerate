    ...
    <header className="mcl-hero">
      <div className="mcl-container">
        <div className="rcl-metaline rcl-hero-rise d1">
          <span>18 уроков</span><i aria-hidden="true" />
        ...
        <div className="rcl-transform rcl-hero-rise d3" role="img" aria-label="От прототипа к бизнесу с платящими клиентами за 3 фазы и 18 уроков">
        ...
        <div className="rcl-transform-cap rcl-hero-rise d3" aria-hidden="true">
          <span>3 фазы</span><i /><span>18 уроков</span><i /><span>3 месяца</span>
        </div>
...
/* ------------------------------------------------------------------ *
 * Curriculum - 18 lessons grouped into 3 months
 * ------------------------------------------------------------------ */
...
const PROGRAM: readonly Month[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { num: "16", title: "Каналы продвижения: что ещё работает", desc: "Партнёрства, инфлюенсеры, комьюнити, запуски, SEO и GEO. Выбираешь два и запускаешь." },
      { num: "17", title: "Что дальше: план на 30 и 90 дней", desc: "Финал программы. Весь курс одной картой, честная точка старта под твою ситуацию и пошаговый план на первый месяц и следующий квартал." },
    ],
  },
];
    ...
    <section className="rcl-program">
      <div className="mcl-container-wide">
        <div className="rcl-program-head">
          ...
          <h2 className="mcl-section-title">18 уроков. <em>От идеи до первого платящего клиента.</em></h2>
          <p className="mcl-section-intro">
...
const BONUSES = [
  ...
  { i: "📊", t: "Презентации всех 18 уроков", d: "Слайды можно пересмотреть без видео, скопировать схемы и использовать как чек-листы." },
...
function Comparison() {
  const rows = [
    ["Структурированный путь", ["no", "Хаос"], ["no", "Нет"], ["yes", "18 уроков"], ["yes", "Да"]],
      ...
      <div className="mcl-container-wide">
        ...
        <div className="rcl-tiers">
          ...
          <div className="rcl-tier">
            ...
            <ul className="rcl-tier-features">
              <li>Все 18 уроков (вводный + 3 месяца), ~15+ часов видео</li>
        ...
        <div className="mcl-container" style={{ padding: 0 }}>
          ...
          <p className="rcl-tier-foot-note">
            Не уверен, что готов к полной программе? Начни с <a href="/ru" style={{ color: "var(--mcl-text)", fontWeight: 600 }}>курса за $19</a> — и зачти его при переходе.
          </p>
        </div>
      </div>
    </section>
 ...
 * ------------------------------------------------------------------ */
const FAQ_ITEMS = [
  { q: "Чем эта программа отличается от курса за $19?", a: ["Тот курс — 5 уроков, ~4 часа: быстрый проход от идеи до первого понимания, кому и что продавать. Это вход.", "Эта программа — 18 уроков на 3 месяца: вся дорога от валидации до построения продукта, запуска, продаж, рекламы, B2B-sales и привлечения средств. Глубже, полнее и с разборами реальных кейсов на каждом этапе."] },
  { q: "В чём разница между тарифами $397 и $997?", a: ["Программа внутри — одна и та же: все 18 уроков, шаблоны, промпты, агенты, доступ навсегда.", "В тарифе за <strong>$997</strong> добавляются 3 личные часовые консультации 1:1 со мной по мере прохождения курса — мы разбираем именно твой продукт. Если тебе важна обратная связь и личное участие, бери его. Если предпочитаешь идти сам в своём темпе — $397 даёт всю программу целиком."] },
  ...
  { q: "Мне нужно сначала пройти базовый курс за $19?", a: ["Не обязательно. Программа самодостаточна и начинается с вводного урока, который вводит в контекст. Но если ты совсем в начале — курс за $19 даёт быстрый и дешёвый способ понять мой подход, и его стоимость засчитывается при переходе."] },
  ...
  return (
    <section className="mcl-final-cta">
      <div className="mcl-container">
        ...
        <p>
          18 уроков, реальные кейсы, весь мой рабочий стек — и, если выберешь, 3 личные консультации со мной. Самая короткая дорога от прототипа до платящих клиентов, которую я могу предложить.
        </p>
  ...
  return (
    <div className="mcl-root rcl-page">
      <SEO
        ...
        description="18 уроков за 3 месяца: от валидации идеи до первых платящих клиентов, запуска, рекламы и продаж. Два тарифа: $397 курс в записи и $997 курс + 3 личные консультации 1:1."
        jsonLd={[
          {
            ...
            description:
              "18 уроков за 3 месяца: от валидации идеи до первых платящих клиентов, запуска, рекламы и продаж.",
            provider: {
              "@type": "Organization",
